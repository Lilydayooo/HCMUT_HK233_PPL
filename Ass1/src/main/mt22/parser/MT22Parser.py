...
class MT22Parser ( Parser ):
    ...
    ruleNames =  [ "program", "decls", "decl", "array_lit", "var_decl", 
                   "ids_list", "exprs_var_list", "func_decl", "params_list", 
    ...
    class Var_declContext(ParserRuleContext):
        ...
        def ids_list(self):
            return self.getTypedRuleContext(MT22Parser.Ids_listContext,0)
        ...
        def exprs_var_list(self):
            return self.getTypedRuleContext(MT22Parser.Exprs_var_listContext,0)
    ...
    class Ids_listContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MT22Parser.RULE_ids_list
    ...
    def ids_list(self):
        ...
        localctx = MT22Parser.Ids_listContext(self, self._ctx, self.state)
    ...
    class Exprs_var_listContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return MT22Parser.RULE_exprs_var_list

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitExprs_var_list" ):
                return visitor.visitExprs_var_list(self)
            else:
                return visitor.visitChildren(self)
    ...
    def exprs_var_list(self):
        ...
        localctx = MT22Parser.Exprs_var_listContext(self, self._ctx, self.state)
        self.enterRule(localctx, 12, self.RULE_exprs_var_list)
        try:
            self.state = 157
            self._errHandler.sync(self)
